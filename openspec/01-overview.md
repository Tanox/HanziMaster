...
| 分类 | 技术 | 版本 | 用途 |
|------|-----|------|------|
| **前端框架** | Angular | 21.0.0 | 前端应用框架 |
| **编程语言** | TypeScript | ~5.9.0 | 开发语言 |
| **样式框架** | Tailwind CSS | 4.0.0 | 样式框架 |
| **UI 组件库** | Angular Material | 21.0.0 | UI 组件 |
| **AI 服务** | @google/genai | latest | Google Gemini AI SDK |
| **动画库** | Motion | 11.11.17 | 动画效果 |
| **图标库** | Angular Material Icons | 21.0.0 | 图标 |
| **字体** | Inter, JetBrains Mono, Noto Sans SC | - | 界面和代码字体 |
| **构建工具** | Angular CLI | 21.0.0 | 项目构建 |
| **开发服务器** | Vite | (通过 Angular) | 开发服务器 |
