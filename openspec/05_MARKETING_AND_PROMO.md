...
### 一句话介绍 (Twitter/X)
精准掌握汉字。交互式笔顺动画遇上 AI 驱动的字源解析——完全离线且免费。 🏮✍️ #HanziMaster #LearnChinese

### "Product Hunt" 风格介绍
学习汉字通常意味着死记硬背。HanziMaster 通过将矢量级精准的笔顺动画与 Google Gemini AI 相结合，改变了这一现状。

我们不只是展示*如何*写“休”字；我们告诉你*为什么*它是一个人靠在树上。凭借离线优先的架构，你的字典可以随身携带到任何地方。
...
4.  **隐私专注**: 无需注册。你的 API Key (可选)，你的数据。
...
我最近添加了一个 AI 层（使用 Gemini）来解释汉字的*字源*，这有助于记忆。最棒的部分是？它会缓存所有内容，所以可以完全离线工作。
