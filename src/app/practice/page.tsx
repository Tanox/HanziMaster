  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold tracking-tight mb-2 text-slate-900 dark:text-white">{t('common.practice')}</h2>
        <p className="text-slate-500 dark:text-slate-400">Coming soon - Practice your characters with interactive exercises</p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-3xl p-12 border border-slate-100 dark:border-slate-700 shadow-lg text-center">
        ...
        <h3 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white">Practice Module</h3>
