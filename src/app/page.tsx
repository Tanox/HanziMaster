          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.05]">
                ...
                <br />
                <span className="text-emerald-600 dark:text-emerald-400">{t('home.heroTitle2')}</span>
              </h1>
            ...
            <div className="relative flex items-center justify-center">
              <div className="relative w-full">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-50 to-cyan-50 dark:from-emerald-950/30 dark:to-cyan-950/30 rounded-[3rem] -z-10 transform rotate-3" />
                  ...
                  <div className="flex justify-center items-center gap-2 mt-8">
                    {HERO_CHARS.map((c, i) => (
                      <button
                        ...
                        aria-label={c.char}
                        className={`h-2 rounded-full transition-all ${i === charIdx ? 'w-6 bg-emerald-500' : 'w-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300'}`}
                      />
                    ))}
                  </div>
            ...
            <FeatureCard
              ...
              icon={
                <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                </svg>
              }
            />
            <FeatureCard
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={i}
                className="feature-card bg-white dark:bg-gray-900 rounded-3xl p-8 apple-shadow-sm"
              >
              ...
              <div className="space-y-4 mb-8">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-emerald-500 dark:bg-emerald-400 flex-shrink-0 mt-1 flex items-center justify-center">
              ...
              <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] p-8 apple-shadow-2xl">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-emerald-100 dark:bg-emerald-950/40 rounded-xl flex items-center justify-center text-2xl hanzi-font text-emerald-600 dark:text-emerald-400">
                      永
                    </div>
                    <div>
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-xs text-emerald-500">{t('home.structureExcellent')}
                    </div>
                  </div>
                </div>
                ...
                <div className="relative aspect-square rounded-3xl writing-canvas bg-gray-50 dark:bg-gray-950 overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div className="w-[85%] h-[85%] border-2 border-dashed border-gray-200 dark:border-gray-800 rounded-2xl relative">
                      ...
                      <div className="absolute" style={{ top: '55%', left: '32%' }}>
                ...
                <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-100 dark:border-gray-800">
                  <div className="flex gap-2">
                    <button className="w-9 h-9 rounded-xl bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-500 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
