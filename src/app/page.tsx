    ...
    <div className="relative">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center">
        <div className="max-w-6xl mx-auto px-6 py-20 relative z-10 text-center">
          {/* Eyebrow */}
          <div className="text-lg sm:text-xl font-medium text-[#007aff] mb-4 tracking-wide animate-fade-in-up hero-eyebrow opacity-0">
            {t('home.aiBadge')}
          </div>

          {/* Main Heading */}
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-foreground mb-6 leading-[1.05] animate-fade-in-up hero-title opacity-0">
            {t('home.heroTitle')}，
          ...
          {/* Subtitle */}
          <p className="text-xl sm:text-2xl text-muted-foreground max-w-3xl mx-auto mb-10 leading-relaxed animate-fade-in-up hero-subtitle opacity-0">
            {t('home.heroDescription')}
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16 animate-fade-in-up hero-cta opacity-0">
          ...
          {/* Visual Card */}
          <div className="bg-gradient-to-b from-muted to-background rounded-[32px] p-10 sm:p-12 border border-border max-w-4xl mx-auto animate-fade-in-up hero-visual opacity-0">
