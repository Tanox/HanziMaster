      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 py-20 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16 animate-fade-in-elegant hero-cta opacity-0">
            <Button asChild size="lg" className="rounded-full bg-vermilion-500 hover:bg-vermilion-600 text-primary-foreground shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-[colors,transform,opacity] duration-300">
              <Link href="/learn">
