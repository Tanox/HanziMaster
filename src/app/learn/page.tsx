            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <div className="text-center lg:text-left">
                <div className="inline-flex items-center gap-2 mb-6">
                  ...
                  <Button variant="ghost" size="sm" onClick={() => speak(selectedCharacter.hanzi)} className="text-ink-500 dark:text-ink-400 hover:text-vermilion-500">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button variant="outline" onClick={() => { const idx = characters.findIndex((c) => c.id === (selectedCharacterId ?? -1)); const next = characters[(idx + 1) % characters.length]; setSelectedCharacterId(next.id); }} className="rounded-full border-ink-200 text-ink-700 dark:border-ink-700 dark:text-ink-200">
