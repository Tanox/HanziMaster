// src/components/practice/weekly-progress.tsx v5.0.0
'use client';
  ...
  return (
    <div className="bg-card/80 dark:bg-ink-900/80 backdrop-blur-xl rounded-4xl p-10 border border-ink-100 dark:border-ink-800 reveal shadow-ink-lg">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <StatsCard label="practice.charactersLearned" value="12" icon={icons.pencil} accentVariant="vermilion" />
        <StatsCard label="practice.dayStreak" value="5" icon={icons.question} accentVariant="indigo" />
        <StatsCard label="practice.accuracy" value="87%" icon={icons.chart} accentVariant="success" />
      </div>
    </div>
  );
}
