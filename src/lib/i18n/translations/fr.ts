...
export const fr = {
  ...
  practice: {
    title: 'Pratique',
    subtitle: 'Pratiquez vos caractères avec des exercices interactifs',
    comingSoon: 'Bientôt disponible',
    description: 'Cette fonctionnalité est en cours de développement. Bientôt vous pourrez pratiquer l\'écriture des caractères, tester vos connaissances et suivre vos progrès.',
    canvasPlaceholder: 'Dessinez votre caractère ici',
    ...
    practiceModule: 'Module de pratique',
  },
  footer: {
