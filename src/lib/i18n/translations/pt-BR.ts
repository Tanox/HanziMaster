...
export const ptBR = {
  ...
  learn: {
    ...
    words: {
      ...
      mountainWater: 'Montanhas e rios',
      climbMountain: 'Subir a montanha',
      snowMountain: 'Montanha de neve',
      fruit: 'Fruta',
    ...
    example: {
      ...
      openMouth: 'Por favor, abra sua boca.',
      goodDay: 'Hoje é um bom dia.',
      beautifulMoon: 'A lua é bonita esta noite.',
      climbMountain: 'Eu quero subir a montanha.',
