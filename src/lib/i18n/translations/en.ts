// src/lib/i18n/translations/en.ts v5.2.15
export const en = {
  common: {
    home: 'Home',
    learn: 'Learn',
  ...
  practice: {
    ...
    question: 'Question',
    learnedCharacters: 'Learned Characters',
  ...
  learn: {
    ...
    example: {
      ...
      climbMountain: 'I want to go mountain climbing.',
  ...
  footer: {
    copyright: '© 2026 HanziMaster 汉字大师 v5.2.17. All rights reserved.',
  },
  meta: {
