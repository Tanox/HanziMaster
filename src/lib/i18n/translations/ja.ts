...
export const ja = {
  ...
  home: {
    ...
    aiInsightsTitle: 'AI主導のインサイト',
    aiInsightsDesc: 'AIがあなたの書き方を分析し、画の改善点を提案します。',
    ...
    yongCharacterDesc: '永という文字を通じて8つの基本笔画をマスターし、中国書道の真髄をアンロックする',
    yongCharacterStrokes: '画マスター度',
  },
  practice: {
    center: 'センター',
    question: '問題',
  ...
  learn: {
    ...
    example: {
      ...
      threeApples: '机の上にリンゴが三つあります。',
      goodPerson: '彼はいい人です。',
      bigApple: 'これは大きなリンゴです。',
      cuteCat: '子猫はとてもかわいいです。',
      openMouth: '口を開けてください。',
      goodDay: '今日はいい天気です。',
      beautifulMoon: '今夜の月は美しいです。',
      climbMountain: '山に登りたいです。',
      glassOfWater: 'コップ一杯の水をください。',
      carefulFire: '火気に注意！',
    },
  },
  footer: {
  ...
  meta: {
    ...
    description: 'AI主導の中国語文字学習プラットフォーム',
  },
};
