...
export const id: UILabels = {
  ...
  settingShowMainTitle: 'Tampilkan judul aplikasi di beranda',
  settingShowCommonCharacters: 'Tampilkan daftar karakter umum',
  recentHistory: 'Pencarian terbaru',
  tryCharacters: 'Jelajahi karakter',
  clearBtn: 'Hapus',
  learningPathTitle: 'Jalur pembelajaran',
  learningPathL1Title: 'L1: Fondasi',
  learningPathL1Desc: 'Guratan dasar & aturan inti',
  learningPathL2Title: 'L2: Kemajuan',
