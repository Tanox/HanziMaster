...
export const ko: UILabels = {
  ...
  generateVideo: '획순 비디오 생성',
  videoGenerating: '비디오 생성 중 (몇 분 소요될 수 있습니다)...',
  videoReady: '비디오 준비 완료!',
  videoError: '비디오 생성 실패. 다시 시도해주세요.',
  selectApiKey: 'API 키 선택',
  apiKeyRequired: '비디오 생성을 위해서는 유료 Gemini API 키가 필요합니다. Google Cloud 프로젝트에서 API 키를 선택해주세요.',
  settingShowMainTitle: '홈페이지에 앱 제목 표시',
  settingShowCommonCharacters: '상용 한자 목록 표시',
  recentHistory: '최근 검색',
  tryCharacters: '한자 탐색',
  clearBtn: '지우기',
  learningPathTitle: '학습 경로',
  learningPathL1Title: 'L1: 기초',
  learningPathL1Desc: '기본 획과 핵심 규칙',
  learningPathL2Title: 'L2: 심화',
  learningPathL2Desc: '구조와 부수',
  learningPathL3Title: 'L3: 숙달',
  learningPathL3Desc: '복잡한 한자와 문화',
  springFestival: '설날',
