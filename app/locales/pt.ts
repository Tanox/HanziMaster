...
// app/locales/pt.ts v1.3.4
import { UILabels } from '../types';

export const pt: UILabels = {
  commonCharacters: 'Caracteres Comuns',
  showMore: 'Mostrar Mais',
  showLess: 'Mostrar Menos',
  startChallenge: 'Iniciar Desafio de Escrita',
  writingChallenge: 'Desafio de Escrita',
  challengeInstruction: 'Escreva o caractere acima!',
  timeUp: 'O tempo acabou!',
  leaderboard: 'Quadro de Líderes',
  clearScores: 'Limpar',
  noScores: 'Ainda não há pontuações. Aceite um desafio!',
  meaning: 'Significado',
  structure: 'Estrutura',
  radical: 'Radical',
  strokeCount: 'Traços',
  ...
  settingShowMainTitle: 'Mostrar título do aplicativo na página inicial',
  settingShowCommonCharacters: 'Mostrar lista de caracteres comuns',
  recentHistory: 'Buscas recentes',
  tryCharacters: 'Explorar caracteres',
  clearBtn: 'Limpar',
  learningPathTitle: 'Caminho de aprendizagem',
  learningPathL1Title: 'L1: Fundação',
  learningPathL1Desc: 'Traços básicos e regras fundamentais',
  learningPathL2Title: 'L2: Avanço',
  learningPathL2Desc: 'Estruturas e radicais',
  learningPathL3Title: 'L3: Maestria',
  learningPathL3Desc: 'Caracteres complexos e cultura',
