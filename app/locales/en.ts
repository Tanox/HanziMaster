...
export const en: UILabels = {
  ...
  recentHistory: 'Recent Searches',
  tryCharacters: 'Explore Characters',
  clearBtn: 'Clear',
  learningPathTitle: 'Learning Path',
  learningPathL1Title: 'L1: Foundation',
  learningPathL1Desc: 'Basic strokes & core rules',
  learningPathL2Title: 'L2: Advancement',
  learningPathL2Desc: 'Structures & radicals',
  learningPathL3Title: 'L3: Mastery',
  learningPathL3Desc: 'Complex characters & culture',
  progressTitle: "Learning Progress",
  statsLearned: "Total Items",
  statsNew: "New",
