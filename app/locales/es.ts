...
export const es: UILabels = {
  ...
  welcomeIntroTitle: 'El Alma de Hanzi',
  welcomeIntroDesc: 'HanziMaster es un espacio consciente diseñado para cerrar la brecha entre la caligrafía antigua y la IA moderna.',
  welcomeFeatureTitle: 'Cómo Aprender',
  welcomeFeatureDesc: 'Domina los caracteres a través de la intuición visual y la etimología impulsada por IA.',
  ...
  guideAIDesc: 'Desbloquea la etimología y mnemotecnia impulsada por Gemini AI.',
  ...
  dictionaryCoverage: 'Diccionario Offline',
  dictionaryStatus: '{count} definiciones guardadas',
  downloadingDictionary: 'Sincronizando Diccionario...',
  dictionaryReady: 'Diccionario Listo',
  dictionaryError: 'Error de sincronización',
};