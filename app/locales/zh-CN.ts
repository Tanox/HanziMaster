...
export const zhCN: UILabels = {
  ...
  footerAbout: '关于',
  aboutTitle: '关于汉字大师',
  aboutSubtitle: '发现汉字之美，掌握书写之道',
  aboutVisionTitle: '我们的愿景',
  aboutVisionDesc: '在数字化时代，提笔忘字已成为普遍现象。汉字大师旨在通过趣味性的交互设计与 AI 辅助教学，降低汉字学习的门槛，让每一个人都能感受到汉字结构的韵律之美。',
  aboutFeature1Title: '智能评分',
  aboutFeature1Desc: '基于 AI 的笔画识别与评分系统，实时反馈书写质量。',
  aboutFeature2Title: '动态演示',
  aboutFeature2Desc: '精美的笔顺动画演示，支持多种书写风格与速度调节。',
  aboutFeature3Title: '多语言支持',
  aboutFeature3Desc: '支持 15+ 种语言界面，让全球学习者都能轻松上手。',
  aboutFeature4Title: '隐私保护',
