...
export const zhTW: UILabels = {
  ...
  settingShowMainTitle: '在首頁顯示應用大標題',
  settingShowCommonCharacters: '顯示常用漢字列表',
  recentHistory: '最近搜索',
  tryCharacters: '探索漢字',
  clearBtn: '清除',
  learningPathTitle: '學習路徑',
  learningPathL1Title: 'L1: 筑基',
  learningPathL1Desc: '基礎筆畫與核心規則',
  learningPathL2Title: 'L2: 升華',
  ...
  footerAbout: '關於',
  aboutTitle: '關於漢字大師',
  aboutSubtitle: '發現漢字之美，掌握書写之道',
  aboutVisionTitle: '我們的願景',
  aboutVisionDesc: '在數字化時代，提筆忘字已成為普遍現象。漢字大師旨在通过趣味性的交互設計與 AI 輔助教學，降低漢字學習的門檻，讓每一個人都能感受到漢字結構的韻律之美。',
  aboutFeature1Title: '智能評分',
  aboutFeature1Desc: '基於 AI 的筆畫識別與評分系統，實時反饋書寫質量。',
  aboutFeature2Title: '動態演示',
  aboutFeature2Desc: '精美的筆順動畫演示，支持多種書寫風格與速度調節。',
  aboutFeature3Title: '多語言支持',
  aboutFeature3Desc: '支持 15+ 種語言界面，讓全球學習者都能輕鬆上手。',
  aboutFeature4Title: '隱私保護',
  aboutFeature4Desc: '所有練習數據均存儲在本地，尊重用戶隱私，無需強制註冊。',
  backToHome: '返回首頁',
  aboutIntro: '漢字大師 (HanziMaster) 是一款致力於通过現代科技傳承書法藝術的交互式學習平台。我們相信，書寫不僅是記錄語言的工具，更是一种連接心靈与文化的橋樑。',
};
