...
export const zhTW: UILabels = {
  ...
  welcomeIntroDesc: '漢字大師旨在彌合千年書法藝術與尖端人工智能之間的鴻溝。我們為您提供一個靜謐的空間，在這裡，每一個漢字不再是死記硬背的圖形，而是躍然紙上的生命之歌。',
  welcomeFeatureTitle: '開啟智慧之旅',
  welcomeFeatureDesc: '通過全方位多維度的引導，助您從初學者成長為書法與漢字文化的鑑賞家。',
  ...
  guideAIDesc: 'Gemini 智能引擎揭秘字源演變與記憶口訣。',
