...
export const it: UILabels = {
  commonCharacters: 'Caratteri Comuni',
  showMore: 'Mostra di più',
  showLess: 'Mostra di meno',
  startChallenge: 'Inizia Sfida di Scrittura',
  writingChallenge: 'Sfida di Scrittura',
  challengeInstruction: 'Scrivi il carattere sopra!',
  timeUp: 'Tempo scaduto!',
  leaderboard: 'Classifica',
  clearScores: 'Cancella',
  noScores: 'Ancora nessun punteggio. Accetta una sfida!',
  meaning: 'Significato',
  structure: 'Struttura',
  radical: 'Radicale',
  strokeCount: 'Tratti',
  ...
  settingSoundEffects: 'Effetti Sonori',
  ...
  generateVideo: 'Genera Video Tratti',
  videoGenerating: 'Generazione video (potrebbe richiedere alcuni minuti)...',
  videoReady: 'Video Pronto!',
  videoError: 'Generazione video fallita. Riprova.',
  selectApiKey: 'Seleziona Chiave API',
  apiKeyRequired: 'La generazione video richiede una chiave API Gemini a pagamento. Seleziona una chiave API dal tuo progetto Google Cloud.',
  settingShowMainTitle: 'Mostra il titolo dell\'app nella home page',
  settingShowCommonCharacters: 'Mostra l\'elenco dei caratteri comuni',
  recentHistory: 'Ricerche recenti',
  tryCharacters: 'Esplora i caratteri',
  clearBtn: 'Cancella',
  learningPathTitle: 'Percorso di apprendimento',
  learningPathL1Title: 'L1: Fondamenta',
  learningPathL1Desc: 'Tratti base e regole fondamentali',
  learningPathL2Title: 'L2: Avanzamento',
